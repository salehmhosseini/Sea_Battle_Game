...
public class Winner1 implements ActionListener{
    ...
    // winner label ( the red winner label ) ;
    JLabel winnerLabel = new JLabel();
    // green arrow ; ( direction of this arrow to winner) 
    ...
    ImageIcon winnerArrow1 = new ImageIcon("winLeftArrow.png");
    ...
    crown.setBounds(310, 110, crown1.getIconWidth(), crown1.getIconHeight());
    
    winnerArrow.setIcon(winnerArrow1);
    winnerArrow.setBounds(685, 360, winnerArrow1.getIconWidth(), winnerArrow1.getIconHeight());
    ...
    winnerLabel.setBounds(630, 110, winnerLabel1.getIconWidth(), winnerLabel1.getIconHeight());
            ...
            player_1.setBounds(315, -110, 400, 400);
            player_1.setFont(new Font("segoe print" , Font.BOLD ,45));
           
            player_2.setBounds(1136, -110, 400, 400);
